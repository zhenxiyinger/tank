...
<div class="layui-input-block">
    ...
    <a href="{{ $cash_url }}/loan/loan-detail?id=7604&clientType=wap&utmsource=hengdaqianbao" target="_blank" class="layui-btn layui-btn-danger">借款详情</a>
...
<div class="layui-input-block">
    ...
    <a href="{{ $cash_url }}/loan/loan-repayment-type?id=7612" target="_blank" class="layui-btn layui-btn-danger">选择还款方式</a>
